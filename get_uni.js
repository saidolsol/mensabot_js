...
function get_uni() {
  var urls = {
    "UZH untere Mensa A":
      "http://www.mensa.uzh.ch/de/menueplaene/zentrum-mercato/",
    "UZH obere Mensa B":
      "http://www.mensa.uzh.ch/de/menueplaene/zentrum-mensa/",
    ...
    "UZH Tierspital":
      "http://www.mensa.uzh.ch/de/menueplaene/cafeteria-uzh-tierspital/",
    "UZH Zentrum Für Zahnmedizin":
      "http://www.mensa.uzh.ch/de/menueplaene/cafeteria-zzm/",
    "UZH Platte":
      "http://www.mensa.uzh.ch/de/menueplaene/cafeteria-uzh-plattenstrasse/",
    "UZH Rämi 59 (vegi)": "http://www.mensa.uzh.ch/de/menueplaene/raemi59/"
  };
  var urls_abig = {
    "UZH untere Mensa A (abend)":
      "http://www.mensa.uzh.ch/de/menueplaene/zentrum-mercato-abend/",
    "UZH Irchel (abend)":
      "http://www.mensa.uzh.ch/de/menueplaene/irchel-cafeteria-seerose-abend/"
  };
  var weekdays = [
    "",
    "montag",
      ...
      request(
        ...
        function(error, response, body) {
          if (!error && response.statusCode == 200) {
            ...
            console.error(
              "could not get uni " + mensaName + " dinner menu from internet"
            );
            console.log(error);
          }
        }
...
function makeObject(body, isDinner, mensaName) {
  ...
  var nodes = select(
    "//x:div[@class='mod mod-newslist']/x:ul/x:li/x:div/x:div//text()",
    doc
  );
